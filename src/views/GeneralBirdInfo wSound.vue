            ...
            <div class="bird-details">
              <div class="bird-section stats-section">
                <div class="section-header">
                  <img src="../assets/ui/paper-piece-long-tape.png" alt="Paper tape" class="section-header-bg">
                  <h3>Stats</h3>
                </div>
                <div class="bird-stats">
                  <div class="stat-bar">
                    <span class="stat-label">Size</span>
                    <div class="stat-value" :style="{ width: `${3 * 20}%` }"></div> <!-- bird.stats.size -->
                  </div>
                  <div class="stat-bar">
                    <span class="stat-label">Rarity</span>
                    <div class="stat-value" :style="{ width: `${4 * 20}%` }"></div>
                  </div>
                  <div class="stat-bar">
                    <span class="stat-label">Song Complexity</span>
                    <div class="stat-value" :style="{ width: `${2 * 20}%` }"></div>
                  </div>
                  <div class="stat-bar">
                    <span class="stat-label">Colorfulness</span>
                    <div class="stat-value" :style="{ width: `${2 * 20}%` }"></div>
                  </div>
                  <div class="stat-bar">
                    <span class="stat-label">Friendliness</span>
                    <div class="stat-value" :style="{ width: `${3 * 20}%` }"></div>
                  </div>
                </div>
              </div>
